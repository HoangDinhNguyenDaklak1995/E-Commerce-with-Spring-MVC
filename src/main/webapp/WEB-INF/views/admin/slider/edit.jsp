		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<s:form method="POST" name="form-profile" modelAttribute="slide" onsubmit="return validateForm()"
						 action="${pageContext.request.contextPath}/admin/slider/edit" enctype="multipart/form-data"> 	
							<div class="row">
								<div class="col-md-6">
								 <div class="custom-file-upload">
									...
									<img src="${pageContext.request.contextPath}/uploads/images/${slide.name}" width="120">
								</div>
								</div>
								<div class="col-md-6">
							...
							<button type="submit" class="btn btn-primary pull-right">Edit Slide</button>
							<s:hidden path="id"/>
